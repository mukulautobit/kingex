...
const InstrumentOrderPlace = () => {
  ...
  return (
    <div>
      ...
      <TrendingListHeader label={instrumentData.name} showFilterSearch={false} />
      ...
      `}
          ...
          <div className="bg-blacksecondary mt-2 rounded-[20px] p-[16px] flex flex-col gap-[20px]">
            ...
            <div>
              ...
              <div
                className="
                 border border-[rgba(217,217,217,0.2)]
                 rounded-[10px]
                 h-[44px] px-[12px]
                 flex items-center
                 bg-[#181818]
              ...
              >
                ...
                <button
                  ...
                  flex items-center justify-center
                   border-l border-[rgba(217,217,217,0.2)]
                   "
                >
                  <img
                    src={exchangeIcon}
    ...
    "
        ...
        placeholder:text-[rgba(200,200,200,0.3)]
      "
                />
                <button
                  type="button"
      ...
      <label className="flex items-center gap-2 cursor-pointer">
        ...
        <span
          className={`w-[10px] h-[10px] rounded-full ${
            value === "intraday" ? "bg-main" : "border border-[#6B7C90]"
          }`}
        />
        <span className="text-white text-[12px]">Intraday</span>
      </label>
      ...
      <label className="flex items-center gap-2 cursor-pointer">
        ...
        />
        <span className="text-white text-[12px]">Longterm</span>
      </label>
    </div>
          </div>
        </div>
